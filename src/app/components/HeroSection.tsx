...
function HeroText() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-center leading-[0] not-italic relative shrink-0 text-[#545454] text-center w-full">
      <div className="flex flex-col font-['General_Sans',sans-serif] font-bold justify-center relative shrink-0 text-[56px] w-full max-w-[750px] mx-auto">
        <p>
          <span className="leading-[1.4]">{`Unlock Your Study Power with `}</span>
          <span className="leading-[1.4] text-[#f97316]">NoteSpace</span>
        </p>
      </div>
      <div className="flex flex-col font-['General_Sans',sans-serif] font-normal justify-center relative shrink-0 text-[20px] w-full max-w-[680px] mx-auto">
